...
// Per-file content-hash cache-busting for images/audio now lives entirely
// in the SEPARATE assets repo (github.com/FarhadKamal/soulclash-assets,
// served via GitHub Pages) - moved 2026-09-04 to get Render's own
// bandwidth-billed free tier out of the business of serving the ~54MB
// asset set at all (confirmed report: heavy iterative image-asset work in
// a single session alone pushed past 1GB of a 5GB/month cap). That repo's
// own build-manifest.js regenerates asset-manifest.json whenever an asset
// changes; assetVersion.js (client) fetches it directly from GitHub Pages
// now, not from this server. This server no longer builds or serves any
// asset manifest itself.
